...
Apple said that after macOS 27, Rosetta app support will be deprecated. This script will list all of the apps on your system and display the architecture type, so you can determine which applications need updated.
